...
<body class="g-sidenav-show bg-gray-200">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card card-blog card-plain">
                                        <div class="card-header p-0 mt-n4 mx-3">
                                            <a class="d-block shadow-xl border-radius-xl">
                                                <img src="<?= base_url('assets/img/home-decor-1.jpg'); ?>" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                            </a>
                                        </div>
                                        <div class="card-body p-3">
                                ...
                                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                                    <div class="card card-blog card-plain">
                                        <div class="card-header p-0 mt-n4 mx-3">
                                            <a class="d-block shadow-xl border-radius-xl">
                                                <img src="<?= base_url('assets/img/home-decor-3.jpg'); ?>" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                            </a>
                                        </div>
                                        <div class="card-body p-3">
    ...
    <script src="<?= base_url('assets/js/material-dashboard.js?v=3.1.0'); ?>"></script>
</body>
